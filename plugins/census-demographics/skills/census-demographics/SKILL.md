...
description: >
  Download US Census demographic data and create choropleth maps for any US geography
  (state, county, tract). ALWAYS use for: "census map", "population density map",
  "demographic visualization", "choropleth map of X", "map median income by county",
  "education levels by state", "race distribution map", "census data for X", or any
  request combining US geographic areas with demographic metrics.
---
